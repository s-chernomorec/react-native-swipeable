...
var Swipeable = function (_PureComponent) {
  ...
  function Swipeable(props) {
    ...
    var _this$props6 = _this.props,
        onPanAnimatedValueRef = _this$props6.onPanAnimatedValueRef,
        onRef = _this$props6.onRef;
  ...
  _createClass(Swipeable, [{
    ...
    value: function _renderButtons(buttons, isLeftButtons) {
      ...
      var leftEnd = canSwipeLeft ? -this._limitXValue(width) : 0;
      var rightEnd = canSwipeRight ? this._limitXValue(width) : 0;
