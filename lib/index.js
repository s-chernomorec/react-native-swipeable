...
var Swipeable = function (_PureComponent) {
  ...
  function Swipeable() {
    ...
    }, _this._unmounted = false, _this._handlePan = _reactNative.Animated.event([null, _this.props.handlePan(_this.state.pan)]), _this._handleMoveShouldSetPanResponder = function (event, gestureState) {
...
Swipeable.propTypes = {
  ...
  handlePan: _propTypes.PropTypes.func,
...
Swipeable.defaultProps = {
  ...
  // base swipe lifecycle
  handlePan: function handlePan(pan) {
    return {
      dx: pan.x,
      dy: pan.y
    };
