...
var Swipeable = function (_PureComponent) {
  ...
  function Swipeable() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Swipeable.__proto__ || Object.getPrototypeOf(Swipeable)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      pan: _this.props.panValue || new _reactNative.Animated.ValueXY(),
      width: 0,
      lastOffset: { x: 0, y: 0 },
    ...
    }, _this._bounceOnMount = function () {
      if (_this._canSwipeLeft()) {
        _this.bounceRight(_this.bounceLeft);
      } else if (_this._canSwipeRight()) {
        _this.bounceLeft();
      }
    }, _this.bounceRight = function (onDone) {
      if (_this._canSwipeLeft()) {
        _this.setState({
      ...
      var _this$props = _this.props,
          swipeReleaseAnimationFn = _this$props.swipeReleaseAnimationFn,
          swipeReleaseAnimationConfig = _this$props.swipeReleaseAnimationConfig;
      ...
      var _this$props2 = _this.props,
          swipeStartMinDistance = _this$props2.swipeStartMinDistance,
          swipeStartMinLeftEdgeClearance = _this$props2.swipeStartMinLeftEdgeClearance,
          swipeStartMinRightEdgeClearance = _this$props2.swipeStartMinRightEdgeClearance;

      var gestureStartX = gestureState.moveX - gestureState.dx;
      return Math.abs(gestureState.dx) > swipeStartMinDistance && (swipeStartMinLeftEdgeClearance === 0 || gestureStartX >= swipeStartMinLeftEdgeClearance) && (swipeStartMinRightEdgeClearance === 0 || gestureStartX <= _reactNative.Dimensions.get('window').width - swipeStartMinRightEdgeClearance);
      ...
      var _this$props3 = _this.props,
          leftActionActivationDistance = _this$props3.leftActionActivationDistance,
          leftButtonsActivationDistance = _this$props3.leftButtonsActivationDistance,
          onLeftActionActivate = _this$props3.onLeftActionActivate,
          onLeftActionDeactivate = _this$props3.onLeftActionDeactivate,
          onLeftButtonsActivate = _this$props3.onLeftButtonsActivate,
          onLeftButtonsDeactivate = _this$props3.onLeftButtonsDeactivate,
          rightActionActivationDistance = _this$props3.rightActionActivationDistance,
          rightButtonsActivationDistance = _this$props3.rightButtonsActivationDistance,
          onRightActionActivate = _this$props3.onRightActionActivate,
          onRightActionDeactivate = _this$props3.onRightActionDeactivate,
          onRightButtonsActivate = _this$props3.onRightButtonsActivate,
          onRightButtonsDeactivate = _this$props3.onRightButtonsDeactivate,
          onSwipeMove = _this$props3.onSwipeMove;
      ...
      var _this$props4 = _this.props,
          onLeftActionRelease = _this$props4.onLeftActionRelease,
          onLeftActionDeactivate = _this$props4.onLeftActionDeactivate,
          onLeftButtonsOpenRelease = _this$props4.onLeftButtonsOpenRelease,
          onLeftButtonsCloseRelease = _this$props4.onLeftButtonsCloseRelease,
          onRightActionRelease = _this$props4.onRightActionRelease,
          onRightActionDeactivate = _this$props4.onRightActionDeactivate,
          onRightButtonsOpenRelease = _this$props4.onRightButtonsOpenRelease,
          onRightButtonsCloseRelease = _this$props4.onRightButtonsCloseRelease,
          onSwipeRelease = _this$props4.onSwipeRelease;
      ...
      animationFn(pan, animationConfig).start(function () {
        ...
        var _this$props5 = _this.props,
            onLeftActionComplete = _this$props5.onLeftActionComplete,
            onLeftButtonsOpenComplete = _this$props5.onLeftButtonsOpenComplete,
            onLeftButtonsCloseComplete = _this$props5.onLeftButtonsCloseComplete,
            onRightActionComplete = _this$props5.onRightActionComplete,
            onRightButtonsOpenComplete = _this$props5.onRightButtonsOpenComplete,
            onRightButtonsCloseComplete = _this$props5.onRightButtonsCloseComplete,
            onSwipeComplete = _this$props5.onSwipeComplete;
  ...
  _createClass(Swipeable, [{
    ...
    key: '_limitXValue',
    value: function _limitXValue(val) {
    ...
    value: function _renderButtons(buttons, isLeftButtons) {
      ...
      var inputRange = isLeftButtons ? [0, this._limitXValue(rightEnd)] : [this._limitXValue(leftEnd), 0];

      return buttons.map(function (buttonContent, index) {
        var outputMultiplier = -index / count;
        var outputRange = isLeftButtons ? [0, _this2._limitXValue(rightEnd) * outputMultiplier] : [_this2._limitXValue(leftEnd) * outputMultiplier, 0];
        var transform = [{
    ...
    value: function render() {
      ...
      var transform = [{
        translateX: pan.x.interpolate({
          ...
          outputRange: [canSwipeLeft ? -this._limitXValue(width) + _reactNative.StyleSheet.hairlineWidth : 0, canSwipeRight ? this._limitXValue(width) - _reactNative.StyleSheet.hairlineWidth : 0],
          extrapolate: 'clamp'
        })
      }];
...
Swipeable.propTypes = {
  ...
  // misc
  panValue: _propTypes.PropTypes.object,
  processInterpolatedValueX: _propTypes.PropTypes.func,
  ...
  swipeStartMinLeftEdgeClearance: _propTypes.PropTypes.number,
  swipeStartMinRightEdgeClearance: _propTypes.PropTypes.number,
